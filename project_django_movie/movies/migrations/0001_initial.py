# Generated by Django 4.1.7 on 2023-08-19 08:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "poster",
                    models.ImageField(upload_to="movies/", verbose_name="Фото обложки"),
                ),
                (
                    "year",
                    models.PositiveSmallIntegerField(
                        default=2023, verbose_name="дата выхода"
                    ),
                ),
                ...
                (
                    "ganres",
                    models.ManyToManyField(to="movies.ganre", verbose_name="жанры"),
                ),
            ],
            options={
                "verbose_name": "Фильм",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("ip", models.CharField(max_length=50, verbose_name="Рейтинг")),
                (
                    "movie",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
