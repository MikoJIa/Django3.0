...
class Category(models.Model):
    ...
    )  # Текастовое поле которое содержит

    # буквы, цифры, подчеркивание, дефисы

    def __str__(self):
        return self.name

    class Meta:  # Это просто контейнер класса с некоторыми опциями, метаданными прикреплёнными к модели
...
class Movie(models.Model):
    ...
    description = models.TextField("Описание")
    poster = models.ImageField("Фото обложки", upload_to="movies/")
...
class Reting(models.Model):
    """Рейтинг"""
    ip = models.CharField("Рейтинг", max_length=50)
